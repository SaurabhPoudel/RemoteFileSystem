...
public class A extends Frame implements ActionListener, ItemListener {
	   ...
	   */
	  public A(String directory, FilenameFilter filter) {
	  ...
	  public void listDirectory(String directory) {
	    ...
	    if (!dir.isDirectory())
	      throw new IllegalArgumentException("A: no such directory");
	  ...
	  public void itemStateChanged(ItemEvent e) {
	    ...
	    if (!f.exists()) // Confirm that it exists
	      throw new IllegalArgumentException("A: " + "no such file or directory");
	...
	public void actionPerformed(ActionEvent e) {
	  ...
	  public static void usage() {
	    System.out.println("Usage: java A [directory_name] " + "[-e file_extension]");
	    System.exit(0);
	  }

	  /**
	   * A main() method so A can be run standalone. Parse command line
	   * arguments and create the A object. If an extension is specified,
	  ...
	  public static void main(String args[]) throws IOException {
	    ...
	    // Create the A object, with directory and filter specified.
	    f = new A(directory, filter);
